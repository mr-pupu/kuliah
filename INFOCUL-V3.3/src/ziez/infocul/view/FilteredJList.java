...
public class FilteredJList extends JList {
	...
	private int DEFAULT_FIELD_WIDTH = 31;
	...
	class FilterModel extends AbstractListModel {
		ArrayList<Warung> items;
		ArrayList<Warung> filterItems;
		...
		public void addElement(Warung o) {
			items.add(o);
			refilter();
		}
		...
		private void refilter() {
			...
			//	if (items.get(i).toString().indexOf(term, 0) != -1)
					if((items.get(i).getNamaWarung().toUpperCase()).indexOf(term, 0) != -1)
