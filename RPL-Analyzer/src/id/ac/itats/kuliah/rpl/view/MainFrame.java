...
import id.ac.itats.kuliah.rpl.parser.VariableParser;
...
public class MainFrame extends javax.swing.JFrame {
               ...
               public void mouseClicked(MouseEvent evt) {
                    ...
                    if (evt.getClickCount() == 2) {
                         try {
                              ...
                              txVariable.setText("");
                              doParser((File) jList1.getSelectedValue());
     ...
     private void initComponents() {
          ...
          txVariable = new javax.swing.JTextArea();
          jScrollPane4 = new javax.swing.JScrollPane();
          txFunction = new javax.swing.JTextArea();
          jScrollPane2 = new javax.swing.JScrollPane();
          txCommentar = new javax.swing.JTextArea();
          ...
          fileChooser.setCurrentDirectory(new java.io.File("/home/ziez/data"));
          ...
          txVariable.setColumns(20);
          txVariable.setRows(5);
          jScrollPane3.setViewportView(txVariable);

          jTabbedPane1.addTab("Variabel", jScrollPane3);

          txFunction.setColumns(20);
          txFunction.setRows(5);
          jScrollPane4.setViewportView(txFunction);

          jTabbedPane1.addTab("Function", jScrollPane4);

          txCommentar.setColumns(20);
          txCommentar.setRows(5);
          jScrollPane2.setViewportView(txCommentar);
     ...
     private void btnListNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListNextActionPerformed
          ...
          if (listIndex > jList1.getModel().getSize()) {
     ...
     private javax.swing.JTextArea txCommentar;
     private javax.swing.JTextArea txFunction;
     private javax.swing.JTextField txPath;
     private javax.swing.JTextArea txSrc;
     private javax.swing.JTextArea txSrcList;
     private javax.swing.JTextArea txVariable;
          ...
          if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
               ...
               if (fileChooser.getSelectedFile().isDirectory()) {
                    ...
                    try {
                         ...
                         txVariable.setText("");
                         doParser(fileChooser.getSelectedFile());
     ...
     private void doParser(File file) {
          VariableParser variableParser = new VariableParser(file.getAbsolutePath());

          for (String global : variableParser.getVarGlobal()) {
               txVariable.append(global + "\n");

          }

          for (String local : variableParser.getVarLocal()) {
               txVariable.append(local + "\n");

          }

          for (String param : variableParser.getVarParameter()) {
               txVariable.append(param + "\n");

          }

          chartPanel.setBuffImage(chart.getChartImage(variableParser.getVarGlobal().size() - 1, variableParser.getVarLocal().size() - 1, variableParser.getVarParameter().size() - 1));
     }
}
